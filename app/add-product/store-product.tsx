...
export const filledProduct: Product = {
  name: 'Maya Chen, building workflow intelligence for ops teams',
  description:
    'Ex-Stripe operator with early design partners, sharp workflow wedge, and a warm intro path through two portfolio founders.',
