...
export default function StepAddProductStockStatus() {
  ...
  return (
    <div className='mx-auto flex w-full max-w-[620px] flex-col gap-5 md:gap-6'>
      <div className='flex w-full flex-col gap-6'>
        <RiImageAddFill className='size-7 text-orange-500' />
        <div>
          <div className='text-title-h5 text-text-strong-950'>
            Profile Asset
          </div>
          <div className='mt-2 text-paragraph-md text-text-sub-600'>
            Add the visual asset that makes this investor card shareable.
          </div>
        </div>
      </div>
      ...
      >
        <div className='text-label-md text-text-sub-600'>
          Choose a founder portrait, company logo, or deck cover.
        </div>
        <div className='mt-1 text-label-sm text-text-soft-400'>
          PNG, JPG, PDF, and deck cover assets up to 50 MB.
        </div>
        <Button.Root
          variant='neutral'
          mode='stroke'
