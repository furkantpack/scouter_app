...
export const ADD_PRODUCT_STEPS: AddProductStepItem[] = [
  { index: 0, label: 'Your Fund', comp: StepAddProductDetails },
  { index: 1, label: 'Your Sourcing', comp: StepAddProductDetails },
  { index: 2, label: 'Your Thesis', comp: StepAddProductDetails },
  { index: 3, label: 'Investor Card', comp: StepAddProductDetails },
];
