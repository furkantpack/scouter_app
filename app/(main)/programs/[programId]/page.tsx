...
export default function ProgramDetailPage({ params }: { params: { programId: string } }) {
  ...
  const [fit, setFit] = useState<'90' | '85' | '75' | 'all'>('all');
